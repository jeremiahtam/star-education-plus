...
function AddSchoolPackagesAndServicesDocsModal(props: any) {
    ...
    <>
      <Formik
        ...
        onSubmit={async (values, { setSubmitting, setErrors, resetForm }) => {
          ...
          formData.append("orderedItemsId", props.orderedItemsId)
...
export default AddSchoolPackagesAndServicesDocsModal
